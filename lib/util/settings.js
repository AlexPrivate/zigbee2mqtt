...
const defaults = {
    ...
    advanced: {
        base_topic: '/devices',
        zigbee_topic: '/devices/zigbee/controls',
        zigbee_meta_topic: '/devices/zigbee/meta/name',
        state_topic: '/devices/zigbee/controls/state',
        log_topic: '/devices/zigbee/controls/log',
        config_topic: '/devices/zigbee/controls/config',
