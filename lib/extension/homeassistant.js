...
class HomeAssistant {
    ...
    discover(entityID, mappedModel, force=false) {
        ...
        mapping[mappedModel.model].forEach((config) => {
            ...
            const stateTopic = `${settings.get().advanced.base_topic}/${entity.friendlyName}`;
            ...
            if (settings.get().advanced.availability_timeout) {
                payload.availability_topic = `${settings.get().advanced.base_topic}/${entity.friendlyName}/controls/availability`;
            } else {
                payload.availability_topic = `${settings.get().advanced.state_topic}`;
            }
            ...
            if (payload.command_topic) {
                payload.command_topic = `${settings.get().advanced.base_topic}/${entity.friendlyName}/`;
