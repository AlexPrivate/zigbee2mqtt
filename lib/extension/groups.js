...
const topicRegex = new RegExp(`^${settings.get().advanced.zigbee_topic}/bridge/group/.+/(remove|add|remove_all)$`);
...
class Groups {
    ...
    onMQTTConnected() {
        this.mqtt.subscribe(`${settings.get().advanced.zigbee_topic}/bridge/group/+/remove`);
        this.mqtt.subscribe(`${settings.get().advanced.zigbee_topic}/bridge/group/+/add`);
        this.mqtt.subscribe(`${settings.get().advanced.zigbee_topic}/bridge/group/+/remove_all`);
    }
    ...
    parseTopic(topic) {
        ...
        topic = topic.replace(`${settings.get().advanced.zigbee_topic}/bridge/group/`, '');
