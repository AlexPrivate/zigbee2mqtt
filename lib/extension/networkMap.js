...
class NetworkMap {
    constructor(zigbee, mqtt, state, publishEntityState) {
        ...
        // Subscribe to topic.
        this.topic = `${settings.get().advanced.zigbee_topic}/bridge/networkmap`;
    ...
    onMQTTMessage(topic, message) {
        ...
        if (topic === this.topic && this.supportedFormats.hasOwnProperty(message)) {
            this.zigbee.networkScan((result)=> {
                ...
                this.mqtt.publish(`${settings.get().advanced.zigbee_topic}/bridge/networkmap/${message}`, converted, {});
            });
